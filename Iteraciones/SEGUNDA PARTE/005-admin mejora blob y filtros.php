  ...
  <style>
    *{ box-sizing:border-box; }
    ...
    thead tr.filter-row th{
      position: sticky;
      top: 34px;              /* ajusta si cambias alto del header */
      z-index: 1;
    ...
    .filter-input:focus, .filter-select:focus{
      border-color: rgba(58,169,170,.70);
      box-shadow: 0 0 0 4px rgba(95,191,192,.16);
    }
  </style>
</head>
