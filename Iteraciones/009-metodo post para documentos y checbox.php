  ...
  <head>
    ...
    <style>
      ...
      *{
      ...
      /* Checkbox (para que no quede gigante) */
      .control_formulario input[type="checkbox"]{
        width: 18px;
        height: 18px;
        margin: 0;
      }
            ...
            if($f['Key'] != "PRI" || $f['Extra'] == "DEFAULT_GENERATED"){
              ...
              if (str_contains($f['Type'], "varchar")) {
                ...
                if (str_contains($f['Type'], "tinyint")) {
                  ...
                  // Esto hace que SIEMPRE llegue un valor:
                  // - si no marcas: llega 0
                  // - si marcas: llega 1 (porque el checkbox pisa el hidden)
